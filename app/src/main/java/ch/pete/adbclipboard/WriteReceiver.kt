    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        try {
            ...
            if (existingClip != null
                ...
                // Background apps are denied clipboard writes on many devices
                // (e.g. MIUI), so write through a transparent foreground activity.
                val bridgeIntent = Intent(context, ClipboardWriteActivity::class.java)
                    .putExtra(ClipboardWriteActivity.EXTRA_TEXT, text)
